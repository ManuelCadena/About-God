  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Simulate MDP kernel state (in production from API)
        ...
        const rewards: RewardFunction[] = [
          { component: "ΔVEP", weight: 0.50, currentValue: 1.24, contribution: 0.62 },
          { component: "ΔPE", weight: 0.30, currentValue: 0.85, contribution: 0.255 },
          { component: "ΔIPF", weight: 0.15, currentValue: -0.12, contribution: -0.018 },
