  ...
  const fetchLLMAnalysis = async () => {
    ...
    try {
      const analysis = await generatePanelAnalysis({
        panelId: 'watson-programa',
        value: programa.resumen_global?.total_aplicaciones || 0,
        data: {
          generado: programa.generado,
          total_aplicaciones: programa.resumen_global?.total_aplicaciones,
          costo_total_finca: programa.resumen_global?.costo_total_finca,
          secciones: programa.resumen_global?.secciones,
          seccion_seleccionada: selectedSection
        }
      });
      ...
      <div className="mt-6 bg-gradient-to-br from-cyan-900/30 to-blue-900/30 rounded-xl p-6 border border-cyan-500/30">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-cyan-300">Interpretación Programa Anual - Claude AI</p>
            </div>
          </div>
          <button
        ...
        <div className="mt-4 p-3 bg-gray-900/50 rounded-lg border border-gray-700">
          <p className="text-xs text-gray-400">
            <span className="text-white font-medium">Fuente:</span> Análisis generado por Claude AI basado en Watson Programa Anual.
